-- JayZGUI_v2.3_Fixed.lua - Part 1/8
...
local configSuccess, configError = pcall(function()
    ConfigSystem = loadstring(game:HttpGet("https://raw.githubusercontent.com/hahahahehe9911-ui/module/refs/heads/main/configs/SaveConfig.lua"))()
end)
...
task.spawn(function()
    ...
    pcall(function()
        if ConfigSystem and configStatusText and configStatusText.Parent then
            ...
            pcall(function()
                hasConfigFile = isfile("JayZGUI_Configs/JayZ_config.json")
            end)
...
SendNotification("✨ JayZ GUI v2.3", "Loaded successfully! " .. loadedModules .. "/" .. totalModules .. " modules ready.", 5)
...
--
-- 🚀 JayZ GUI v2.3 IMPROVED - READY TO USE!
-- ============================================
