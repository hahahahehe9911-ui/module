-- ConfigSystem.lua
-- Auto Save/Load Configuration System for JayZ GUI
-- FREE NOT FOR SALE
...
-- CONFIG SETTINGS
-- ============================================
local CONFIG_FOLDER = "JayZGUI_Configs"
local CONFIG_FILE = CONFIG_FOLDER .. "/JayZ_config.json"
